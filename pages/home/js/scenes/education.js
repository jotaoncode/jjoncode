var educationScene = new Scene();
_.extend(educationScene, {
  endAnimation: function (ev) {
    if (ev && ev.preventDefault) {
      ev.preventDefault();
    }
    if (isAnimating) {
      educationActor.endAnimation();
      ...
      this.finishedAnimation(scenes.education);
    }
  ...
  start: function() {
    ...
    window.setTimeout(function () {
      ...
      .then(magicBlastActor.showEducationCardUtn.bind(magicBlastActor), self.endAnimation.bind(self))
      .then(wandActor.wandStayAlive.bind(wandActor), self.endAnimation.bind(self))
      .then(educationActor.showUtn.bind(educationActor), self.endAnimation.bind(self))
      .then(wandActor.sendMagic.bind(wandActor), self.endAnimation.bind(self))
      .then(magicBlastActor.showEducationCardCambridge.bind(magicBlastActor), self.endAnimation.bind(self))
      .then(educationActor.showCambridge.bind(educationActor), self.endAnimation.bind(self))
